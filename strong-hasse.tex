...
Suppose that $a_2\equiv0(\mod{p_i})$, that is $a_2=p_ia_2'$ for some $a_2'\in\mathbb{Z}_{p_i}$, then $a_2$ is trivially a square modulo $p_i$, because $0=p_i0$, hence $0\equiv0(\mod{p}_i)$, which means that $a_2$ and $0$ are in the same congruence class modulo $p_i$ (and $0$ is a square of itself), hence we assume that $a_2\not\equiv0(\mod{p_i})$ and move to show that it is a (nonzero) square modulo $p_i$.\\
\newline
