...
\]
But $p^{v_p(r)}\in\mathbb{Q}$, for every prime $p$, hence $a_2$ is a square in $\mathbb{Q}$, that is $a_2=a_2'^2$ for some $a_2'\in\mathbb{Q}$, so taking $v_2=\frac{v_1}{a_2'}$ shows that $v'=(v_1,\frac{v_1}{a_2'})\in\mathbb{Q}^2$ yields $q(v')=v_1^2-a_2(\frac{v_1}{a_2'})^2=v_1^2-a_2\frac{v_1^2}{a_2}=v_1^2-v_1^2=0$.
\section*{$n=3$}
